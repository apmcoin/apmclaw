...
function resolveResolutionLimits(config: ApmClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: ApmClawConfig): SecretProviderConfig {
