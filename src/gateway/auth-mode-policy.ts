...
export function hasAmbiguousGatewayAuthModeConfig(cfg: ApmClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: ApmClawConfig): void {
