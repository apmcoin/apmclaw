...
function resolveAnthropicDefaultAuthMode(cfg: ApmClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ApmClawConfig): ApmClawConfig {
...
export function applyTalkApiKey(config: ApmClawConfig): ApmClawConfig {
...
export function applyTalkConfigNormalization(config: ApmClawConfig): ApmClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: ApmClawConfig): ApmClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ApmClawConfig): ApmClawConfig {
...
export function applyLoggingDefaults(cfg: ApmClawConfig): ApmClawConfig {
...
export function applyContextPruningDefaults(cfg: ApmClawConfig): ApmClawConfig {
...
export function applyCompactionDefaults(cfg: ApmClawConfig): ApmClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
