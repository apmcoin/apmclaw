...
import { resolveApmClawPackageRoot } from "../infra/openclaw-root.js";
...
function resolveMode(cfg: ApmClawConfig): "local" | "remote" {
...
export async function doctorCommand(
  ...
  let cfg: ApmClawConfig = configResult.cfg;
