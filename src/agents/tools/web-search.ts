...
type WebSearchConfig = NonNullable<ApmClawConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: ApmClawConfig): WebSearchConfig {
