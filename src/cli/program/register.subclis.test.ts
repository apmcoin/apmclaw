...
describe("registerSubCliCommands", () => {
  ...
  const originalDisableLazySubcommands = process.env.APMCLAW_DISABLE_LAZY_SUBCOMMANDS;
  ...
  beforeEach(() => {
    if (originalDisableLazySubcommands === undefined) {
      delete process.env.APMCLAW_DISABLE_LAZY_SUBCOMMANDS;
    } else {
      process.env.APMCLAW_DISABLE_LAZY_SUBCOMMANDS = originalDisableLazySubcommands;
    }
