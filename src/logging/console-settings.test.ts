...
let originalApmClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalApmClawTestConsole = process.env.APMCLAW_TEST_CONSOLE;
  process.env.APMCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalApmClawTestConsole === undefined) {
    delete process.env.APMCLAW_TEST_CONSOLE;
  } else {
    process.env.APMCLAW_TEST_CONSOLE = originalApmClawTestConsole;
  }
