...
export function isAcpEnabledByPolicy(cfg: ApmClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: ApmClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: ApmClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: ApmClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: ApmClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: ApmClawConfig, agentId: string): boolean {
