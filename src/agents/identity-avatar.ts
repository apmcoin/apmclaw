...
function resolveAvatarSource(cfg: ApmClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ApmClawConfig, agentId: string): AgentAvatarResolution {
