import type { BrowserConfig, BrowserProfileConfig, ApmClawConfig } from "../config/config.js";
...
import {
  ...
  DEFAULT_APMCLAW_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_APMCLAW_BROWSER_COLOR;
  }
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_APMCLAW_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_APMCLAW_BROWSER_PROFILE_NAME] = {
 ...
 *
 * Note: this is an ApmClaw browser profile (routing config), not a Chrome user profile.
...
export function resolveBrowserConfig(
  ...
  rootConfig?: ApmClawConfig,
): ResolvedBrowserConfig {
  const enabled = cfg?.enabled ?? DEFAULT_APMCLAW_BROWSER_ENABLED;
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ? DEFAULT_BROWSER_DEFAULT_PROFILE_NAME
      : profiles[DEFAULT_APMCLAW_BROWSER_PROFILE_NAME]
        ? DEFAULT_APMCLAW_BROWSER_PROFILE_NAME
        : "chrome");
