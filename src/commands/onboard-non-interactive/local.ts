...
export async function runNonInteractiveOnboardingLocal(params: {
  ...
  let nextConfig: ApmClawConfig = applyOnboardingLocalWorkspaceConfig(baseConfig, workspaceDir);
  ...
  if (!opts.json) {
    runtime.log(
      `Tip: run \`${formatCliCommand("openclaw configure --section web")}\` to store your Brave API key for web_search. Docs: https://docs.apmclaw.ai/tools/web`,
    );
  }
}
