...
function asApmClawConfig(config: Partial<ApmClawConfig>): ApmClawConfig {
  return config as ApmClawConfig;
}

function createToolConfig() {
  return asApmClawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: ApmClawConfig = createToolConfig()) {
