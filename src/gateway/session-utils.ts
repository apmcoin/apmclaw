...
import { type ApmClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ApmClawConfig): string[] {
...
export function listAgentsForGateway(cfg: ApmClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ApmClawConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: ApmClawConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: ApmClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ApmClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ApmClawConfig): GatewaySessionsDefaults {
