...
describe("GatewayClient security checks", () => {
  const envSnapshot = captureEnv(["APMCLAW_ALLOW_INSECURE_PRIVATE_WS"]);
  ...
  it("allows ws:// to private addresses only with APMCLAW_ALLOW_INSECURE_PRIVATE_WS=1", () => {
  ...
  it("allows ws:// hostnames with APMCLAW_ALLOW_INSECURE_PRIVATE_WS=1", () => {
    process.env.APMCLAW_ALLOW_INSECURE_PRIVATE_WS = "1";
    const onConnectError = vi.fn();
    const client = new GatewayClient({
