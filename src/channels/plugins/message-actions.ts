...
export function listChannelMessageActions(cfg: ApmClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ApmClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: ApmClawConfig): boolean {
