...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["APMCLAW_BUNDLED_HOOKS_DIR"]);
    process.env.APMCLAW_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: ApmClawConfig) => {
