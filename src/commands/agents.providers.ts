...
function resolveDefaultAccountId(cfg: ApmClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ApmClawConfig): boolean {
...
export function summarizeBindings(cfg: ApmClawConfig, bindings: AgentBinding[]): string[] {
