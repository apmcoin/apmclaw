...
import { discoverApmClawPlugins } from "../../plugins/discovery.js";
import type { ApmClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ApmClawPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["APMCLAW_PLUGIN_CATALOG_PATHS", "APMCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ApmClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: ApmClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: ApmClawPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverApmClawPlugins({ workspaceDir: options.workspaceDir });
