...
export type ChannelAgentToolFactory = (params: { cfg?: ApmClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ApmClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: ApmClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ApmClawConfig }) => boolean;
  supportsCards?: (params: { cfg: ApmClawConfig }) => boolean;
