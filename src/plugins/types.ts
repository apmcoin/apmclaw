...
export type ApmClawPluginConfigSchema = {
...
export type ApmClawPluginToolContext = {
...
export type ApmClawPluginToolFactory = (
  ctx: ApmClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type ApmClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type ApmClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<ApmClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type ApmClawPluginGatewayMethod = {
  method: string;
 ...
 */
export type ApmClawPluginCommandDefinition = {
...
export type ApmClawPluginHttpRouteAuth = "gateway" | "plugin";
export type ApmClawPluginHttpRouteMatch = "exact" | "prefix";

export type ApmClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type ApmClawPluginHttpRouteParams = {
  path: string;
...
export type ApmClawPluginCliContext = {
  program: Command;
  config: ApmClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type ApmClawPluginCliRegistrar = (ctx: ApmClawPluginCliContext) => void | Promise<void>;

export type ApmClawPluginServiceContext = {
  config: ApmClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type ApmClawPluginService = {
  id: string;
  start: (ctx: ApmClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: ApmClawPluginServiceContext) => void | Promise<void>;
};

export type ApmClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type ApmClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: ApmClawPluginConfigSchema;
  register?: (api: ApmClawPluginApi) => void | Promise<void>;
  activate?: (api: ApmClawPluginApi) => void | Promise<void>;
};

export type ApmClawPluginModule =
  | ApmClawPluginDefinition
  | ((api: ApmClawPluginApi) => void | Promise<void>);

export type ApmClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  registerTool: (
    ...
    opts?: ApmClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: ApmClawPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: ApmClawPluginHttpRouteParams) => void;
  registerChannel: (registration: ApmClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: ApmClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: ApmClawPluginService) => void;
   ...
   */
  registerCommand: (command: ApmClawPluginCommandDefinition) => void;
