...
export function listBindings(cfg: ApmClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: ApmClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ApmClawConfig) {
