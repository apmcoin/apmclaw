...
export async function startGatewaySidecars(params: {
  ...
  pluginRegistry: ReturnType<typeof loadApmClawPlugins>;
  ...
  // Tests can opt out via APMCLAW_SKIP_CHANNELS (or legacy APMCLAW_SKIP_PROVIDERS).
  const skipChannels =
  ...
  if (!skipChannels) {
    ...
    params.logChannels.info(
      "skipping channel start (APMCLAW_SKIP_CHANNELS=1 or APMCLAW_SKIP_PROVIDERS=1)",
    );
  }
