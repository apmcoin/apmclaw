...
describe("registerQrCli", () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    vi.stubEnv("APMCLAW_GATEWAY_TOKEN", "");
    vi.stubEnv("CLAWDBOT_GATEWAY_TOKEN", "");
    vi.stubEnv("APMCLAW_GATEWAY_PASSWORD", "");
  ...
  it("uses APMCLAW_GATEWAY_PASSWORD without resolving local password SecretRef", async () => {
    vi.stubEnv("APMCLAW_GATEWAY_PASSWORD", "password-from-env");
    loadConfig.mockReturnValue({
      secrets: {
        providers: {
          default: { source: "env" },
