...
function resolveMainSessionKeyForSandbox(params: { cfg?: ApmClawConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: ApmClawConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
