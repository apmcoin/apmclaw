...
const ENTRY_WRAPPER_PAIRS = [
  { wrapperBasename: "apmclaw.mjs", entryBasename: "entry.js" },
  { wrapperBasename: "apmclaw.js", entryBasename: "entry.js" },
] as const;
...
if (
  ...
  if (shouldForceReadOnlyAuthStore(process.argv)) {
    process.env.APMCLAW_AUTH_STORE_READONLY = "1";
  }
  ...
  function ensureExperimentalWarningSuppressed(): boolean {
    ...
    if (isTruthyEnvValue(process.env.APMCLAW_NO_RESPAWN)) {
      return false;
    }
    if (isTruthyEnvValue(process.env.APMCLAW_NODE_OPTIONS_READY)) {
      return false;
    }
    ...
    process.env.APMCLAW_NODE_OPTIONS_READY = "1";
