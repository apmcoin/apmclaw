...
const FAST_TEST_MODE = process.env.APMCLAW_TEST_FAST === "1";
    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            '`agents_list` and `subagents` apply to ApmClaw sub-agents (`runtime: "subagent"`); ACP harness ids are controlled by `acp.allowedAgents`.',
            ...
            'Use `subagents` only for ApmClaw subagents (`runtime: "subagent"`).',
