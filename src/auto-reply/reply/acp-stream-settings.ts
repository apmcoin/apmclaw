...
function resolveAcpStreamCoalesceIdleMs(cfg: ApmClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: ApmClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: ApmClawConfig): AcpProjectionSettings {
