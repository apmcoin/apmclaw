...
function resolveAdaptiveReadMaxBytes(options?: ApmClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createApmClawReadTool(base, {
...
export function createApmClawReadTool(
  base: AnyAgentTool,
  options?: ApmClawReadToolOptions,
): AnyAgentTool {
