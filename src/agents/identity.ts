import type { ApmClawConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: ApmClawConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: ApmClawConfig, agentId: string): string | undefined {
