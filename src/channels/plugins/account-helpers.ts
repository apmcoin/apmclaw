...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: ApmClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: ApmClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: ApmClawConfig): string {
