...
export function resolveHooksConfig(cfg: ApmClawConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: ApmClawConfig, defaultAgentId: string): Set<string> {
